...
Q3.1. Replace the underlines (_____).
...
Q3.2.  Replace the underlines (_____).
...
tower k n = if (k > n) then 1 else div(n + k + 1) k * tower (k+1) n
...
-- Q5.2: toNary
--
-- toNary base n  ==  n' converted to a string in basebase'
--
